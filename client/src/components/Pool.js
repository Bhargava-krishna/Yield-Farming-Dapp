...
class Pool extends Component {
    ...
    updatePoolBalance = () => {
        this.contract.methods.getPoolBalance(this.id).call().then((balance) => {
            this.setState({ poolBalance: Number(this.web3.utils.fromWei(balance)).toFixed(8) });
        });
    }
        ...
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Footer>
                <Row>
                    ...
                    <Col className="right">
                        $ { (this.state.price * this.state.poolBalance).toFixed(4) }
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col className="right">
                        $ { (this.state.price * this.state.userBalance).toFixed(4) }
                    </Col>
                </Row>
            </Card.Footer>
        </Card>
